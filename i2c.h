...
#define I2C_ERR_BUS_OCCUPIED				-2
#define I2C_ERR_SCL_TIMEOUT					-3
#define I2C_ERR_SCL_ACK						-4
#define I2C_ERR_NO_ACK						-5
#define I2C_ERR_STOP_SCL_TIMEOUT			-6
#define I2C_ERR_STOP_SDA_TIMEOUT			-7
